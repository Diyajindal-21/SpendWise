  ...
  <Card className="bg-gradient-to-br from-[#23234a]/80 to-[#181830]/90 border border-white/10 rounded-2xl shadow-xl backdrop-blur-md">
    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4 px-4 pt-4">
      ...
      <Select value={selectedAccountId} onValueChange={setSelectedAccountId}>
        <SelectTrigger className="w-[140px] bg-[#23234a] border border-white/10 text-white rounded-lg focus:ring-2 focus:ring-[#5f5fff] transition">
  ...
  <Card className="bg-gradient-to-br from-[#23234a]/80 to-[#181830]/90 border border-white/10 rounded-2xl shadow-xl backdrop-blur-md">
    ...
    <CardContent className="p-0 pb-5">
      {pieChartData.length === 0 ? (
        <p className="text-center text-[#b0b3c7] py-4">No expenses this month</p>
      ) : (

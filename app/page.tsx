...
export default function Home(){
  return (
    <div className="min-h-screen flex flex-col mt-30 bg-gradient-to-b from-[#23233a] to-[#181830] rounded-lg">
    {/* Hero Section */}
    <Hero />
    ...
    <section className="py-12 sm:py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-12 text-white drop-shadow-lg">
    ...
    <section className="py-12 sm:py-14">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-16 pt-10 text-white drop-shadow-lg">
          How It Works
        </h2>
      ...
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-2xl mx-auto rounded-2xl bg-[#2a2a40] backdrop-blur-md shadow-xl py-10 px-6">
          ...
          <Link href="/dashboard">
            <Button
              size="lg"
              className="text-sm sm:text-base px-6 sm:px-8 py-3 rounded-xl font-bold bg-gradient-to-r from-[#5f5fff] to-[#38bdf8] text-white hover:from-[#38bdf8] hover:to-[#5f5fff] transition"
            >
              Start Free Trial
            </Button>
          </Link>
